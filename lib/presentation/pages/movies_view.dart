...
import '../../common/widgets/buttons/retry_button.dart';
import '../../common/widgets/card/movie_card.dart';
import '../../common/widgets/indicator/base_indicator.dart';
import '../../core/configs/router/app_router.gr.dart';
import '../../domain/entities/export_entities.dart';
import '../bloc/movie/export_movie_cubits.dart';

part '../widgets/movies/movie_listing_widget.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [Tab(text: 'Popular'), Tab(text: 'Top Rated')],
        ),
      ),
      body: TabBarView(
        controller: tabbarController,
          ...
          BlocBuilder<GetTopRatedMoviesCubit, GetTopRatedMoviesState>(
            builder: (context, getTopRatedMoviesState) {
              ...
              if (getTopRatedMoviesState is GetTopRatedMoviesLoaded) {
                return _MovieListingWidget(
                  hasReachedMax:
                      context.watch<GetTopRatedMoviesCubit>().hasReachedMax,

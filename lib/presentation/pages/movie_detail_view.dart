...
import '../../common/widgets/bottom_sheet/social_media_bottom_sheet.dart';
import '../../common/widgets/image/base_network_image.dart';
import '../../common/widgets/buttons/bookmark_button.dart';
...
class _MovieDetailView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    context.read<GetMovieCreditsCubit>().getMovieCredits(movieDetail?.id ?? 0);
    return Hero(
      tag: heroTag,
              ...
              child: ListView.separated(
                ...
                itemBuilder:
                    (_, index) => SizedBox(
                      ...
                      width: 225.w,
                      child: _ActorCard(
                        castEntity: state.movieCreditEntity.cast?[index],
                      ),
                    ),
                separatorBuilder: (_, __) => SizedBox(width: 30.w),

...
void main() {
  ...
  blocTest<GetPopularMoviesCubit, GetPopularMoviesState>(
    ...
    setUp: () {
      ...
      when(
        mockMovieUsecases.getPopularMovies(page: tPage),
    ...
    verify:
        (_) => verify(mockMovieUsecases.getPopularMovies(page: 1)).called(1),
  );
  ...
  blocTest<GetPopularMoviesCubit, GetPopularMoviesState>(
    ...
    setUp: () {
      ...
      when(mockMovieUsecases.getPopularMovies(page: tPage)).thenAnswer(

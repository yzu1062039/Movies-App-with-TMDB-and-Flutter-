  ...
  group('getPopularMovies', () {
    ...
    test(
      ...
      () async {
        // arrange
        when(
          mockMovieRemoteDataSource.getPopularMovies(page: tPage),
  ...
  group('getTopRatedMovies', () {
    ...
    test(
      ...
      () async {
        // arrange
        when(
          mockMovieRemoteDataSource.getTopRatedMovies(page: tPage),
        ).thenAnswer((_) async => tMovieListingsModel);
        // act
  ...
  group('getMovieCredits', () {
    ...
    test(
      ...
      () async {
        // arrange
        when(
          mockMovieRemoteDataSource.getMovieCredits(movieId: tMovieId),
